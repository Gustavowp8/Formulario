...
namespace Formulario
{
    ...
    internal class Cliente
    {
        ...
        public Cliente(string nome, long cPF, DateTime dataNascimento, decimal rendaMensal, EnumEstadoCivil estadoCivil, bool temFilhos, string nacionalidade, string placaVeiculo)
        {
            this.Codigo = 0;
            this.Nome = nome;
            this.CPF = cPF;
